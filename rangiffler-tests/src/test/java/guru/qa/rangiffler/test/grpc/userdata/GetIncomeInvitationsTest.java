...
public class GetIncomeInvitationsTest extends BaseGrpcTest {
    ...
    void getIncomeInvitationsWithCorrectUsernameTest(@User(FOR_GENERATE_USER) UserModel user) {
        ...
        UsersResponse response = userdataGrpcBlockingStub.getIncomeInvitations(request);
    ...
    void getIncomeInvitationsWithIncorrectUsernameTest() {
        ...
        Exception e = Assertions.assertThrows(StatusRuntimeException.class,
                () -> userdataGrpcBlockingStub.getIncomeInvitations(request)
        );
    ...
    @Test
    @GenerateUser
    @DisplayName("GetIncomeInvitations: пустой username, без searchQuery, page, size. Должен вернуть INVALID_ARGUMENT")
    void getIncomeInvitationsWithEmptyUsernameTest() {
        UsersRequest request = UsersRequest.newBuilder()
                .setUsername("")
                .build();
