...
public class RejectFriendTest extends BaseGqlTest {
    ...
    void rejectFriendTest(@User UserModel user,
        ...
        GqlRequest request = new GqlRequest(
                ...
                GqlVariablesUtil.updateFriendship(friendId, FriendshipAction.REJECT),
                template.query()
        );
