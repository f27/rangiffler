...
public class InviteFriendTest extends BaseGqlTest {
    ...
    void inviteFriendTest(@User UserModel user,
        ...
        GqlRequest request = new GqlRequest(
                ...
                GqlVariablesUtil.updateFriendship(friendId, FriendshipAction.ADD),
                template.query()
        );
        ...
        step("Проверить статус друга", () ->
                Assertions.assertEquals(FriendStatus.INVITATION_SENT, gqlResponse.getData().getFriendship().getFriendStatus()));
    }
}
